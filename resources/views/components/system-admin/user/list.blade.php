            ...
            <tbody class="bg-white">
                @foreach($users as $user)
                    <tr class="text-left cursor-default whitespace-nowrap @if(!$user->is_active) bg-common-disabled @endif">
                        ...
                        <td class="py-1 px-5 border-b border-gray-400">{{ $user->base?->base_name }}</td>
                        <td class="py-1 px-5 border-b border-gray-400">{{ $user->user_id }}</td>
                        ...
                        <td class="py-1 px-2 border-b border-gray-400">{{ $user->email }}</td>
                        <td class="py-1 px-2 border-b border-gray-400 text-center">
                            <x-list.status :value="$user->is_active" label1="有効" label0="無効" />
                        </td>
                        <td class="py-1 px-5 border-b border-gray-400">{{ $user->role->role_name }}</td>
                        <td class="py-1 px-2 border-b border-gray-400 text-center">
