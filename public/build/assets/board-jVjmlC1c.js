const l=document.getElementById("board");document.getElementById("tray");const c=parseInt(l.dataset.whiteboardId),N=parseInt(l.dataset.canvasW),P=parseInt(l.dataset.canvasH),d=document.querySelector('meta[name="csrf-token"]').content,k=[{bg:"#E6F1FB",border:"#378ADD",text:"#0C447C"},{bg:"#EAF3DE",border:"#639922",text:"#27500A"},{bg:"#FAEEDA",border:"#BA7517",text:"#633806"},{bg:"#FBEAF0",border:"#D4537E",text:"#72243E"},{bg:"#E1F5EE",border:"#1D9E75",text:"#085041"},{bg:"#EEEDFE",border:"#7F77DD",text:"#3C3489"},{bg:"#FAECE7",border:"#D85A30",text:"#711B13"},{bg:"#FEF9E7",border:"#D4AC0D",text:"#7D6608"},{bg:"#F2F3F4",border:"#717D7E",text:"#2C3E50"},{bg:"#FDEDEC",border:"#C0392B",text:"#7B241C"}],ne=[{border:"#378ADD",bg:"rgba(56,138,221,0.06)",text:"#0C447C"},{border:"#639922",bg:"rgba(99,153,34,0.06)",text:"#27500A"},{border:"#D4537E",bg:"rgba(212,83,126,0.06)",text:"#72243E"},{border:"#BA7517",bg:"rgba(186,117,23,0.06)",text:"#633806"},{border:"#7F77DD",bg:"rgba(127,119,221,0.06)",text:"#3C3489"},{border:"#1D9E75",bg:"rgba(29,158,117,0.06)",text:"#085041"},{border:"#D85A30",bg:"rgba(216,90,48,0.06)",text:"#711B13"},{border:"#D4AC0D",bg:"rgba(212,172,13,0.06)",text:"#7D6608"},{border:"#717D7E",bg:"rgba(113,125,126,0.06)",text:"#2C3E50"},{border:"#C0392B",bg:"rgba(192,57,43,0.06)",text:"#7B241C"}],U=["#374151","#ffffff","#dc2626","#ea580c","#ca8a04","#16a34a","#2563eb","#7c3aed","#ec4899","#000000","#6b7280","#b91c1c","#92400e","#854d0e","#065f46","#1e40af","#5b21b6","#9d174d","#0891b2","#fca5a5","#fdba74","#fde047","#86efac","#93c5fd","#c4b5fd","#f9a8d4","#67e8f9","#9ca3af","#e5e7eb"];let u=0,j=null;function w(e){u=e}function W(e){j=e}let x=null,E=null,Le=0,_e=0,G=null,ue=0,he=0;function ie(e){e.addEventListener("mousedown",i=>et(i,e)),e.addEventListener("touchstart",i=>et(i,e),{passive:!1}),e.addEventListener("mouseenter",()=>{const i=e.querySelector(".chip-edit-btn");i&&(i.style.display="flex");const a=e.querySelector(".chip-copy-btn");a&&(a.style.display="flex");const s=e.querySelector(".chip-resize-handle");s&&(s.style.display="block")}),e.addEventListener("mouseleave",()=>{const i=e.querySelector(".chip-edit-btn");i&&(i.style.display="none");const a=e.querySelector(".chip-copy-btn");a&&(a.style.display="none");const s=e.querySelector(".chip-resize-handle");s&&(s.style.display="none")});const t=e.querySelector(".chip-edit-btn");t&&(t.addEventListener("mousedown",i=>i.stopPropagation()),t.addEventListener("click",i=>{i.stopPropagation(),ko(i,e)}));const o=e.querySelector(".chip-copy-btn");o&&(o.addEventListener("mousedown",i=>i.stopPropagation()),o.addEventListener("click",i=>{i.stopPropagation(),qo(e)}));const n=e.querySelector(".chip-resize-handle");n&&(n.addEventListener("mousedown",i=>tt(i,e)),n.addEventListener("touchstart",i=>tt(i,e),{passive:!1}))}function et(e,t){x&&(x.style.opacity="1",x=null),E&&(E.remove(),E=null);const o=e.touches?e.touches[0].clientX:e.clientX,n=e.touches?e.touches[0].clientY:e.clientY;G=t,ue=o,he=n,document.addEventListener("mousemove",Ce),document.addEventListener("mouseup",Te)}function Ce(e){const t=e.clientX-ue,o=e.clientY-he;(Math.abs(t)>4||Math.abs(o)>4)&&(document.removeEventListener("mousemove",Ce),document.removeEventListener("mouseup",Te),To(G,ue,he),G=null)}function Te(){document.removeEventListener("mousemove",Ce),document.removeEventListener("mouseup",Te),G=null}function To(e,t,o){x=e;const n=e.getBoundingClientRect();Le=t-n.left,_e=o-n.top,E=e.cloneNode(!0),E.style.cssText=`
        position:fixed;pointer-events:none;z-index:9999;opacity:0.85;
        left:${n.left}px;top:${n.top}px;
        transform:rotate(2deg) scale(1.05);
    `,document.body.appendChild(E),e.style.opacity="0.3",document.addEventListener("mousemove",ht),document.addEventListener("mouseup",mt),document.addEventListener("touchmove",ft,{passive:!1}),document.addEventListener("touchend",bt)}function ht(e){yt(e.clientX,e.clientY)}function ft(e){e.preventDefault(),yt(e.touches[0].clientX,e.touches[0].clientY)}function yt(e,t){E.style.left=e-Le+"px",E.style.top=t-_e+"px"}function mt(e){xt(e.clientX,e.clientY)}function bt(e){xt(e.changedTouches[0].clientX,e.changedTouches[0].clientY)}function xt(e,t){document.removeEventListener("mousemove",ht),document.removeEventListener("mouseup",mt),document.removeEventListener("touchmove",ft),document.removeEventListener("touchend",bt),E.remove(),E=null;const o=l.getBoundingClientRect(),n=x.dataset.id;if(e>=o.left&&e<=o.right&&t>=o.top&&t<=o.bottom){let a=e-o.left+l.scrollLeft-Le,s=t-o.top+l.scrollTop-_e;a=Math.max(0,Math.min(a,N-80)),s=Math.max(0,Math.min(s,P-50)),ke(n,!0,a,s),x.style.position="absolute",x.style.left=a+"px",x.style.top=s+"px",document.getElementById("board-canvas").appendChild(x)}x.style.opacity="1",x=null}function ke(e,t,o,n){const i=document.querySelector(`.magnet[data-id="${e}"]`),a=i?i.querySelector(".staff-chip-wrap > div"):null,s=a?{width:a.offsetWidth,height:a.offsetHeight}:null;fetch("/board/item",{method:"POST",headers:{"Content-Type":"application/json","X-CSRF-TOKEN":d},body:JSON.stringify({whiteboard_id:c,item_id:parseInt(e),on_board:t,pos_x:o,pos_y:n,meta:s})})}let L=null,gt=0,vt=0,Et=0,St=0;function tt(e,t){e.stopPropagation(),e.preventDefault(),L=t,gt=e.touches?e.touches[0].clientX:e.clientX,vt=e.touches?e.touches[0].clientY:e.clientY;const o=t.querySelector(".staff-chip-wrap > div");Et=o?o.offsetWidth:90,St=o?o.offsetHeight:40,document.addEventListener("mousemove",wt),document.addEventListener("mouseup",_t),document.addEventListener("touchmove",zt,{passive:!1}),document.addEventListener("touchend",Ct)}function wt(e){Lt(e.clientX,e.clientY)}function zt(e){e.preventDefault(),Lt(e.touches[0].clientX,e.touches[0].clientY)}function Lt(e,t){if(!L)return;const o=L.querySelector(".staff-chip-wrap > div");o&&(o.style.width=Math.max(50,Et+(e-gt))+"px",o.style.height=Math.max(50,St+(t-vt))+"px")}function _t(){Tt()}function Ct(){Tt()}function Tt(){if(document.removeEventListener("mousemove",wt),document.removeEventListener("mouseup",_t),document.removeEventListener("touchmove",zt),document.removeEventListener("touchend",Ct),!L)return;const e=L.querySelector(".staff-chip-wrap > div"),t=L.dataset.id;fetch("/board/item",{method:"POST",headers:{"Content-Type":"application/json","X-CSRF-TOKEN":d},body:JSON.stringify({whiteboard_id:c,item_id:parseInt(t),on_board:!0,pos_x:parseFloat(L.style.left)||0,pos_y:parseFloat(L.style.top)||0,meta:{width:e?e.offsetWidth:90,height:e?e.offsetHeight:40}})}),L=null}let Ie=null,T=null,X=0,kt="M",I="rect";const p=document.createElement("div");p.id="staff-edit-modal";p.style.cssText=`
...
`;document.body.appendChild(p);p.querySelectorAll(".modal-tab").forEach(e=>{e.addEventListener("click",()=>{p.querySelectorAll(".modal-tab").forEach(t=>{t.style.borderBottomColor="transparent",t.style.color="#9ca3af"}),e.style.borderBottomColor="#374151",e.style.color="#374151",document.getElementById("tab-basic").style.display=e.dataset.tab==="basic"?"block":"none",document.getElementById("tab-appearance").style.display=e.dataset.tab==="appearance"?"block":"none"})});p.querySelectorAll(".edit-color-chip").forEach(e=>{e.addEventListener("click",()=>{X=parseInt(e.dataset.color),p.querySelectorAll(".edit-color-chip").forEach(t=>{t.style.transform="scale(1)",t.style.outline="none"}),e.style.transform="scale(1.2)",e.style.outline="2px solid #374151",e.style.outlineOffset="2px"})});p.querySelectorAll(".edit-shape-chip").forEach(e=>{e.addEventListener("click",()=>{I=e.dataset.shape,p.querySelectorAll(".edit-shape-chip").forEach(t=>{t.style.borderColor="#d1d5db",t.style.background="white"}),e.style.borderColor="#374151",e.style.background="#f3f4f6"})});document.getElementById("edit-cancel").addEventListener("click",()=>{p.style.display="none"});function ko(e,t){e.preventDefault(),Ie=t.dataset.id,T=t;const o=p.querySelector('.modal-tab[data-tab="appearance"]');o&&(o.style.display="block"),document.getElementById("edit-name").value=t.dataset.name??"",document.getElementById("edit-role").value=t.dataset.role??"",X=parseInt(t.dataset.color??0)||0,kt=t.dataset.size??"M",I=t.dataset.shape??"rect",p.querySelectorAll(".edit-color-chip").forEach(i=>{i.style.transform="scale(1)",i.style.outline="none"});const n=p.querySelector(`.edit-color-chip[data-color="${X}"]`);n&&(n.style.transform="scale(1.2)",n.style.outline="2px solid #374151",n.style.outlineOffset="2px"),p.querySelectorAll(".edit-shape-chip").forEach(i=>{const a=i.dataset.shape===I;i.style.borderColor=a?"#374151":"#d1d5db",i.style.background=a?"#f3f4f6":"white"}),document.getElementById("tab-basic").style.display="block",document.getElementById("tab-appearance").style.display="none",p.querySelectorAll(".modal-tab").forEach(i=>{const a=i.dataset.tab==="basic";i.style.borderBottomColor=a?"#374151":"transparent",i.style.color=a?"#374151":"#9ca3af"}),p.style.display="flex"}document.getElementById("edit-save").addEventListener("click",()=>{const e=document.getElementById("edit-name").value.trim(),t=document.getElementById("edit-role").value.trim();e&&fetch("/board/staff/"+Ie,{method:"PATCH",headers:{"Content-Type":"application/json","X-CSRF-TOKEN":d},body:JSON.stringify({staff_name:e,role_name:t,color:X,shape:I})}).then(o=>o.json()).then(()=>{const o=k[X],n=T.querySelector(".staff-chip-wrap"),i=n.querySelector("div"),a={rect:"border-radius:8px;clip-path:none;",circle:"border-radius:50%;clip-path:none;",sharp:"border-radius:0;clip-path:none;",rounded_bottom:"border-radius:0 0 50% 50%;clip-path:none;",tab:"border-radius:0 0 8px 8px;clip-path:none;"};i.style.cssText=`
        ...
        </div>`}function qo(e){fetch("/board/staff",{method:"POST",headers:{"Content-Type":"application/json","X-CSRF-TOKEN":d},body:JSON.stringify({whiteboard_id:c,staff_name:e.dataset.name,role_name:e.dataset.role,color:parseInt(e.dataset.color)||0})}).then(t=>t.json()).then(t=>{const o=t.staff,n=document.createElement("div");n.className="magnet absolute cursor-grab select-none",n.dataset.id=o.staff_id,n.dataset.color=o.color,n.dataset.name=o.staff_name,n.dataset.role=o.role_name??"",n.dataset.size=e.dataset.size??"M",n.dataset.shape=e.dataset.shape??"rect",n.innerHTML=e.innerHTML,n.querySelectorAll(".chip-edit-btn, .chip-copy-btn").forEach(s=>s.style.display="none"),n.querySelectorAll(".chip-resize-handle").forEach(s=>s.style.display="none"),ie(n),j!==e&&(w(0),W(e)),w(u+20);const i=(parseFloat(e.style.left)||0)+u,a=(parseFloat(e.style.top)||0)+u;n.style.left=i+"px",n.style.top=a+"px",document.getElementById("board-canvas").appendChild(n),ke(o.staff_id,!0,i,a)})}function $o(e){setTimeout(()=>{if(document.querySelector(`.magnet[data-id="${e.staff_id}"]`))return;const t=k[(e.color??0)%k.length],o=document.createElement("div");o.className="magnet absolute cursor-grab select-none",o.dataset.id=e.staff_id,o.dataset.color=e.color??0,o.dataset.name=e.staff_name,o.dataset.role=e.role_name??"",o.dataset.shape=e.shape??"rect",o.style.left="40px",o.style.top="40px",o.innerHTML=It(e.staff_name,e.role_name??"",t),ie(o),document.getElementById("board-canvas").appendChild(o)},100)}function Oo(e){const t=document.querySelector(`.magnet[data-id="${e.staffId}"]`);t&&t.remove()}function Ro(e){const t=document.querySelector(`.magnet[data-id="${e.staff_id}"]`);if(!t)return;const o=k[(e.color??0)%k.length],n=t.querySelector(".staff-chip-wrap"),i=n==null?void 0:n.querySelector("div");if(!i)return;const a=i.style.width||i.offsetWidth+"px",s=i.style.height||i.offsetHeight+"px",b={rect:"border-radius:8px;",circle:"border-radius:50%;",sharp:"border-radius:0;",rounded_bottom:"border-radius:0 0 50% 50%;",tab:"border-radius:0 0 8px 8px;"};i.style.cssText=`
        background:${o.bg};border:2px solid ${o.border};
        width:${a};height:${s};
        padding:6px;text-align:center;
        ${b[e.shape]??b.rect}
    `,t.dataset.name=e.staff_name,t.dataset.role=e.role_name??"",t.dataset.color=e.color??0,t.dataset.shape=e.shape??"rect";const Y=n.querySelector('[data-field="name"]'),R=n.querySelector('[data-field="role"]');Y&&(Y.textContent=e.staff_name,Y.style.color=o.text),R&&(R.textContent=e.role_name??"",R.style.color=o.text)}function Bo(e){var o,n;const t=document.querySelector(`.magnet[data-id="${e.itemId}"]`);t&&e.onBoard&&(t.style.position="absolute",t.style.left=e.posX+"px",t.style.top=e.posY+"px",(o=e.meta)!=null&&o.width&&(t.querySelector(".staff-chip-wrap > div").style.width=e.meta.width+"px"),(n=e.meta)!=null&&n.height&&(t.querySelector(".staff-chip-wrap > div").style.height=e.meta.height+"px"),document.getElementById("board-canvas").appendChild(t))}let F=null,S=null,qe=0,$e=0,V=null,fe=0,ye=0;function ae(e){e.addEventListener("mousedown",i=>ot(i,e)),e.addEventListener("touchstart",i=>ot(i,e),{passive:!1}),e.addEventListener("mouseenter",()=>{const i=e.querySelector(".zone-edit-btn");i&&(i.style.display="flex");const a=e.querySelector(".zone-copy-btn");a&&(a.style.display="flex");const s=e.querySelector(".zone-resize-handle");s&&(s.style.display="block")}),e.addEventListener("mouseleave",()=>{const i=e.querySelector(".zone-edit-btn");i&&(i.style.display="none");const a=e.querySelector(".zone-copy-btn");a&&(a.style.display="none");const s=e.querySelector(".zone-resize-handle");s&&(s.style.display="none")});const t=e.querySelector(".zone-edit-btn");t&&(t.addEventListener("mousedown",i=>i.stopPropagation()),t.addEventListener("click",i=>{i.stopPropagation(),Xo(e)}));const o=e.querySelector(".zone-copy-btn");o&&(o.addEventListener("mousedown",i=>i.stopPropagation()),o.addEventListener("click",i=>{i.stopPropagation(),No(e)}));const n=e.querySelector(".zone-resize-handle");n&&(n.addEventListener("mousedown",i=>nt(i,e)),n.addEventListener("touchstart",i=>nt(i,e),{passive:!1}))}function ot(e,t){if(e.target.classList.contains("zone-edit-btn")||e.target.classList.contains("zone-copy-btn"))return;F&&(F.style.opacity="1",F=null),S&&(S.remove(),S=null);const o=e.touches?e.touches[0].clientX:e.clientX,n=e.touches?e.touches[0].clientY:e.clientY;V=t,fe=o,ye=n,document.addEventListener("mousemove",Oe),document.addEventListener("mouseup",Re)}function Oe(e){const t=e.clientX-fe,o=e.clientY-ye;(Math.abs(t)>4||Math.abs(o)>4)&&(document.removeEventListener("mousemove",Oe),document.removeEventListener("mouseup",Re),Mo(V,fe,ye),V=null)}function Re(){document.removeEventListener("mousemove",Oe),document.removeEventListener("mouseup",Re),V=null}function Mo(e,t,o){F=e;const n=e.getBoundingClientRect();qe=t-n.left,$e=o-n.top,S=e.cloneNode(!0),S.style.cssText=`
        position:fixed;pointer-events:none;z-index:9998;opacity:0.7;
        left:${n.left}px;top:${n.top}px;
        width:${n.width}px;height:${n.height}px;
    `,document.body.appendChild(S),e.style.opacity="0.3",document.addEventListener("mousemove",qt),document.addEventListener("mouseup",Rt),document.addEventListener("touchmove",$t,{passive:!1}),document.addEventListener("touchend",Bt)}function qt(e){Ot(e.clientX,e.clientY)}function $t(e){e.preventDefault(),Ot(e.touches[0].clientX,e.touches[0].clientY)}function Ot(e,t){S.style.left=e-qe+"px",S.style.top=t-$e+"px"}function Rt(e){Mt(e.clientX,e.clientY)}function Bt(e){Mt(e.changedTouches[0].clientX,e.changedTouches[0].clientY)}function Mt(e,t){document.removeEventListener("mousemove",qt),document.removeEventListener("mouseup",Rt),document.removeEventListener("touchmove",$t),document.removeEventListener("touchend",Bt),S.remove(),S=null;const o=l.getBoundingClientRect(),n=F,i=n.dataset.zoneId;let a=e-o.left+l.scrollLeft-qe,s=t-o.top+l.scrollTop-$e;a=Math.max(0,Math.min(a,N-n.offsetWidth)),s=Math.max(0,Math.min(s,P-n.offsetHeight)),n.style.left=a+"px",n.style.top=s+"px",n.style.opacity="1",F=null,fetch("/board/item",{method:"POST",headers:{"Content-Type":"application/json","X-CSRF-TOKEN":d},body:JSON.stringify({whiteboard_id:c,item_type:"zone",item_id:parseInt(i),on_board:!0,pos_x:a,pos_y:s,meta:{color_index:parseInt(n.dataset.colorIndex??0),label:n.dataset.label??"",width:n.offsetWidth,height:n.offsetHeight}})})}let y=null,Xt=0,Ft=0,At=0,Nt=0;function nt(e,t){e.stopPropagation(),e.preventDefault(),y=t,Xt=e.touches?e.touches[0].clientX:e.clientX,Ft=e.touches?e.touches[0].clientY:e.clientY,At=t.offsetWidth,Nt=t.offsetHeight,document.addEventListener("mousemove",Pt),document.addEventListener("mouseup",Dt),document.addEventListener("touchmove",jt,{passive:!1}),document.addEventListener("touchend",Ht)}function Pt(e){Yt(e.clientX,e.clientY)}function jt(e){e.preventDefault(),Yt(e.touches[0].clientX,e.touches[0].clientY)}function Yt(e,t){y&&(y.style.width=Math.max(100,At+(e-Xt))+"px",y.style.height=Math.max(80,Nt+(t-Ft))+"px")}function Dt(e){Wt()}function Ht(e){Wt()}function Wt(){document.removeEventListener("mousemove",Pt),document.removeEventListener("mouseup",Dt),document.removeEventListener("touchmove",jt),document.removeEventListener("touchend",Ht),y&&(fetch("/board/item",{method:"POST",headers:{"Content-Type":"application/json","X-CSRF-TOKEN":d},body:JSON.stringify({whiteboard_id:c,item_type:"zone",item_id:parseInt(y.dataset.zoneId),on_board:!0,pos_x:parseFloat(y.style.left)||0,pos_y:parseFloat(y.style.top)||0,meta:{color_index:parseInt(y.dataset.colorIndex??0),label:y.dataset.label??"",width:y.offsetWidth,height:y.offsetHeight}})}),y=null)}let h=null,A=0;const g=document.createElement("div");g.id="zone-edit-modal";g.style.cssText=`
    display:none;position:fixed;inset:0;z-index:99999;
    background:rgba(0,0,0,0.4);
    align-items:center;justify-content:center;
`;g.innerHTML=`
...
`;document.body.appendChild(g);g.querySelectorAll(".zone-color-chip").forEach(e=>{e.addEventListener("click",()=>{A=parseInt(e.dataset.colorIndex),g.querySelectorAll(".zone-color-chip").forEach(t=>{t.style.outline="none",t.style.transform="scale(1)"}),e.style.outline="2px solid #374151",e.style.outlineOffset="2px",e.style.transform="scale(1.2)"})});document.getElementById("zone-edit-cancel").addEventListener("click",()=>{g.style.display="none"});document.getElementById("zone-edit-save").addEventListener("click",()=>{const e=document.getElementById("zone-edit-label").value.trim();if(!e)return;const t=ne[A];fetch("/board/item",{method:"POST",headers:{"Content-Type":"application/json","X-CSRF-TOKEN":d},body:JSON.stringify({whiteboard_id:c,item_type:"zone",item_id:parseInt(h.dataset.zoneId),on_board:!0,pos_x:parseFloat(h.style.left)||0,pos_y:parseFloat(h.style.top)||0,meta:{color_index:A,label:e,width:parseFloat(h.style.width)||h.offsetWidth,height:parseFloat(h.style.height)||h.offsetHeight}})}),h.style.borderColor=t.border,h.style.background=t.bg,h.dataset.colorIndex=A,h.dataset.label=e;const o=h.querySelector(".zone-label-text");o&&(o.textContent=e,o.style.color=t.text),g.style.display="none"});document.getElementById("zone-edit-delete").addEventListener("click",()=>{confirm("このグループを削除しますか？")&&fetch("/board/zone/"+h.dataset.zoneId,{method:"DELETE",headers:{"X-CSRF-TOKEN":d}}).then(e=>e.json()).then(()=>{h.remove(),g.style.display="none"})});function Xo(e){h=e,A=parseInt(e.dataset.colorIndex??0),document.getElementById("zone-edit-label").value=e.dataset.label??"",g.querySelectorAll(".zone-color-chip").forEach(t=>{const o=parseInt(t.dataset.colorIndex)===A;t.style.outline=o?"2px solid #374151":"none",t.style.outlineOffset="2px",t.style.transform=o?"scale(1.2)":"scale(1)"}),g.style.display="flex"}function Fo(){const e=document.getElementById("newZoneLabel").value.trim();e&&fetch("/board/zone",{method:"POST",headers:{"Content-Type":"application/json","X-CSRF-TOKEN":d},body:JSON.stringify({whiteboard_id:c,label:e,color_index:0})}).then(t=>t.json()).then(t=>{const o=t.item,n=Be(o);document.getElementById("board-canvas").appendChild(n),ae(n),document.getElementById("newZoneLabel").value=""})}function Be(e){const t=e.meta??{},o=ne[t.color_index??0],n=document.createElement("div");return n.className="zone magnet-zone cursor-grab select-none absolute border-2 rounded-xl",n.dataset.zoneId=e.whiteboard_item_id,n.dataset.colorIndex=t.color_index??0,n.dataset.label=t.label??"",n.style.cssText=`
    ...
    `}function No(e){fetch("/board/zone",{method:"POST",headers:{"Content-Type":"application/json","X-CSRF-TOKEN":d},body:JSON.stringify({whiteboard_id:c,label:e.dataset.label,color_index:parseInt(e.dataset.colorIndex??0)})}).then(t=>t.json()).then(t=>{const o=t.item;j!==e&&(w(0),W(e)),w(u+20);const n=(parseFloat(e.style.left)||0)+u,i=(parseFloat(e.style.top)||0)+u;o.pos_x=n,o.pos_y=i,o.meta.width=e.offsetWidth,o.meta.height=e.offsetHeight;const a=Be(o);a.querySelectorAll(".zone-edit-btn, .zone-copy-btn").forEach(s=>s.style.display="none"),a.querySelectorAll(".zone-resize-handle").forEach(s=>s.style.display="none"),document.getElementById("board-canvas").appendChild(a),ae(a),fetch("/board/item",{method:"POST",headers:{"Content-Type":"application/json","X-CSRF-TOKEN":d},body:JSON.stringify({whiteboard_id:c,item_type:"zone",item_id:parseInt(o.whiteboard_item_id),on_board:!0,pos_x:n,pos_y:i,meta:o.meta})})})}function Po(e){if(document.querySelector(`.magnet-zone[data-zone-id="${e.whiteboard_item_id}"]`))return;const t=Be(e);document.getElementById("board-canvas").appendChild(t),ae(t)}function jo(e){const t=document.querySelector(`.magnet-zone[data-zone-id="${e.zoneId}"]`);t&&t.remove()}function Yo(e){var o,n,i,a;const t=document.querySelector(`.magnet-zone[data-zone-id="${e.itemId}"]`);if(t){if(t.style.left=e.posX+"px",t.style.top=e.posY+"px",(o=e.meta)!=null&&o.width&&(t.style.width=e.meta.width+"px"),(n=e.meta)!=null&&n.height&&(t.style.height=e.meta.height+"px"),((i=e.meta)==null?void 0:i.colorIndex)!==void 0){const s=ne[e.meta.colorIndex];t.style.borderColor=s.border,t.style.background=s.bg}if((a=e.meta)!=null&&a.label){const s=t.querySelector(".zone-label-text");s&&(s.textContent=e.meta.label)}}}function Me(e){const t=e.meta??{},o=document.createElement("div");return o.className="text-box absolute cursor-grab select-none",o.dataset.textId=e.whiteboard_item_id,o.style.cssText=`
    ...
    `,s}function re(e){e.addEventListener("mousedown",s=>rt(s,e)),e.addEventListener("touchstart",s=>rt(s,e),{passive:!1}),e.addEventListener("mouseenter",()=>{e.querySelector(".shape-delete-btn").style.display="block",e.querySelector(".shape-copy-btn").style.display="block",e.querySelector(".shape-color-btn").style.display="block",e.querySelector(".shape-resize-handle").style.display="block",e.querySelector(".shape-rotate-handle").style.display="block"}),e.addEventListener("mouseleave",s=>{s.relatedTarget&&s.relatedTarget.classList.contains("shape-rotate-handle")||(e.querySelector(".shape-delete-btn").style.display="none",e.querySelector(".shape-copy-btn").style.display="none",e.querySelector(".shape-color-btn").style.display="none",e.querySelector(".shape-resize-handle").style.display="none",e.querySelector(".shape-rotate-handle").style.display="none")});const t=e.querySelector(".shape-delete-btn");t.addEventListener("mousedown",s=>s.stopPropagation()),t.addEventListener("click",s=>{s.stopPropagation(),confirm("この図形を削除しますか？")&&fetch("/board/shape/"+e.dataset.shapeId,{method:"DELETE",headers:{"X-CSRF-TOKEN":d}}).then(b=>b.json()).then(()=>e.remove())});const o=e.querySelector(".shape-copy-btn");o.addEventListener("mousedown",s=>s.stopPropagation()),o.addEventListener("click",s=>{s.stopPropagation(),Qo(e)});const n=e.querySelector(".shape-color-btn");n.addEventListener("mousedown",s=>s.stopPropagation()),n.addEventListener("click",s=>{s.stopPropagation(),Vo(e)});const i=e.querySelector(".shape-resize-handle");i.addEventListener("mousedown",s=>dt(s,e)),i.addEventListener("touchstart",s=>dt(s,e),{passive:!1});const a=e.querySelector(".shape-rotate-handle");a.addEventListener("mouseleave",s=>{v||s.relatedTarget&&(s.relatedTarget===e||e.contains(s.relatedTarget))||(e.querySelector(".shape-delete-btn").style.display="none",e.querySelector(".shape-copy-btn").style.display="none",e.querySelector(".shape-color-btn").style.display="none",e.querySelector(".shape-resize-handle").style.display="none",a.style.display="none")}),a.addEventListener("mousedown",s=>Go(s,e))}let ge=null,$=null,Ye=0,De=0,ee=null,ve=0,Ee=0;function rt(e,t){if(e.target.classList.contains("shape-delete-btn")||e.target.classList.contains("shape-copy-btn")||e.target.classList.contains("shape-color-btn")||e.target.classList.contains("shape-resize-handle")||e.target.classList.contains("shape-rotate-handle"))return;const o=e.touches?e.touches[0].clientX:e.clientX,n=e.touches?e.touches[0].clientY:e.clientY;ee=t,ve=o,Ee=n,document.addEventListener("mousemove",He),document.addEventListener("mouseup",We)}function He(e){const t=e.clientX-ve,o=e.clientY-Ee;(Math.abs(t)>4||Math.abs(o)>4)&&(document.removeEventListener("mousemove",He),document.removeEventListener("mouseup",We),Uo(ee,ve,Ee),ee=null)}function We(){document.removeEventListener("mousemove",He),document.removeEventListener("mouseup",We),ee=null}function Uo(e,t,o){ge=e;const n=e.getBoundingClientRect();Ye=t-n.left,De=o-n.top,$=e.cloneNode(!0),$.style.cssText+=`position:fixed;pointer-events:none;z-index:9998;opacity:0.7;
        left:${n.left}px;top:${n.top}px;width:${n.width}px;`,document.body.appendChild($),e.style.opacity="0.3",document.addEventListener("mousemove",to),document.addEventListener("mouseup",oo)}function to(e){$.style.left=e.clientX-Ye+"px",$.style.top=e.clientY-De+"px"}function oo(e){document.removeEventListener("mousemove",to),document.removeEventListener("mouseup",oo),$.remove(),$=null;const t=l.getBoundingClientRect(),o=ge;let n=e.clientX-t.left+l.scrollLeft-Ye,i=e.clientY-t.top+l.scrollTop-De;n=Math.max(0,Math.min(n,N-o.offsetWidth)),i=Math.max(0,Math.min(i,P-o.offsetHeight)),o.style.left=n+"px",o.style.top=i+"px",o.style.opacity="1",ge=null,de(o,n,i)}function de(e,t,o){fetch("/board/item",{method:"POST",headers:{"Content-Type":"application/json","X-CSRF-TOKEN":d},body:JSON.stringify({whiteboard_id:c,item_type:"shape",item_id:parseInt(e.dataset.shapeId),on_board:!0,pos_x:t,pos_y:o,meta:{shape_type:e.dataset.shapeType,fill_color:e.dataset.fillColor,stroke_color:e.dataset.strokeColor,rotation:parseInt(e.dataset.rotation)||0,width:e.offsetWidth,height:e.offsetHeight}})})}let _=null,no=0,io=0,ao=0,so=0;function dt(e,t){e.stopPropagation(),e.preventDefault(),_=t,no=e.touches?e.touches[0].clientX:e.clientX,io=e.touches?e.touches[0].clientY:e.clientY,ao=t.offsetWidth,so=t.offsetHeight,document.addEventListener("mousemove",ro),document.addEventListener("mouseup",lo)}function ro(e){_&&(_.style.width=Math.max(20,ao+(e.clientX-no))+"px",_.style.height=Math.max(20,so+(e.clientY-io))+"px")}function lo(){document.removeEventListener("mousemove",ro),document.removeEventListener("mouseup",lo),_&&(de(_,parseFloat(_.style.left)||0,parseFloat(_.style.top)||0),_=null)}let v=null,co=0,po=0;function Go(e,t){e.stopPropagation(),e.preventDefault(),v=t;const o=t.getBoundingClientRect();co=o.left+o.width/2,po=o.top+o.height/2,parseInt(t.dataset.rotation),document.addEventListener("mousemove",uo),document.addEventListener("mouseup",ho)}function uo(e){if(!v)return;const t=e.clientX-co,o=e.clientY-po,n=Math.round(Math.atan2(o,t)*(180/Math.PI)+90);v.style.transform=`rotate(${n}deg)`,v.dataset.rotation=n}function ho(){document.removeEventListener("mousemove",uo),document.removeEventListener("mouseup",ho),v&&(de(v,parseFloat(v.style.left)||0,parseFloat(v.style.top)||0),v=null)}const m=document.createElement("div");m.id="shape-color-modal";m.style.cssText=`
    display:none;position:fixed;inset:0;z-index:99999;
    background:rgba(0,0,0,0.4);
    align-items:center;justify-content:center;
`;m.innerHTML=`
...
`;document.body.appendChild(m);let z=null;document.getElementById("shape-color-cancel").addEventListener("click",()=>{m.style.display="none"});let D="#93c5fd",H="#2563eb";m.querySelectorAll(".fill-chip").forEach(e=>{e.addEventListener("click",()=>{D=e.dataset.color,m.querySelectorAll(".fill-chip").forEach(t=>{t.style.outline="none",t.style.transform="scale(1)"}),e.style.outline="2px solid #374151",e.style.outlineOffset="2px",e.style.transform="scale(1.2)"})});m.querySelectorAll(".stroke-chip").forEach(e=>{e.addEventListener("click",()=>{H=e.dataset.color,m.querySelectorAll(".stroke-chip").forEach(t=>{t.style.outline="none",t.style.transform="scale(1)"}),e.style.outline="2px solid #374151",e.style.outlineOffset="2px",e.style.transform="scale(1.2)"})});document.getElementById("shape-color-save").addEventListener("click",()=>{z.dataset.fillColor=D,z.dataset.strokeColor=H;const e=z.querySelector("svg");e.innerHTML=Pe(z.dataset.shapeType,D,H,z.dataset.shapeId),de(z,parseFloat(z.style.left)||0,parseFloat(z.style.top)||0),m.style.display="none"});function Vo(e){z=e,D=e.dataset.fillColor||"#93c5fd",H=e.dataset.strokeColor||"#2563eb",m.querySelectorAll(".fill-chip").forEach(t=>{const o=t.dataset.color===D;t.style.outline=o?"2px solid #374151":"none",t.style.outlineOffset="2px",t.style.transform=o?"scale(1.2)":"scale(1)"}),m.querySelectorAll(".stroke-chip").forEach(t=>{const o=t.dataset.color===H;t.style.outline=o?"2px solid #374151":"none",t.style.outlineOffset="2px",t.style.transform=o?"scale(1.2)":"scale(1)"}),m.style.display="flex"}function Qo(e){fetch("/board/shape",{method:"POST",headers:{"Content-Type":"application/json","X-CSRF-TOKEN":d},body:JSON.stringify({whiteboard_id:c,shape_type:e.dataset.shapeType})}).then(t=>t.json()).then(t=>{const o=t.item;j!==e&&(w(0),W(e)),w(u+20);const n=(parseFloat(e.style.left)||0)+u,i=(parseFloat(e.style.top)||0)+u;o.pos_x=n,o.pos_y=i,o.meta={shape_type:e.dataset.shapeType,fill_color:e.dataset.fillColor,stroke_color:e.dataset.strokeColor,rotation:parseInt(e.dataset.rotation)||0,width:e.offsetWidth,height:e.offsetHeight};const a=je(o);a.querySelectorAll(".shape-delete-btn, .shape-copy-btn, .shape-color-btn").forEach(s=>s.style.display="none"),a.querySelectorAll(".shape-resize-handle, .shape-rotate-handle").forEach(s=>s.style.display="none"),document.getElementById("board-canvas").appendChild(a),re(a),fetch("/board/item",{method:"POST",headers:{"Content-Type":"application/json","X-CSRF-TOKEN":d},body:JSON.stringify({whiteboard_id:c,item_type:"shape",item_id:parseInt(o.whiteboard_item_id),on_board:!0,pos_x:n,pos_y:i,meta:o.meta})})})}function en(e){fetch("/board/shape",{method:"POST",headers:{"Content-Type":"application/json","X-CSRF-TOKEN":d},body:JSON.stringify({whiteboard_id:c,shape_type:e})}).then(t=>t.json()).then(t=>{const o=je(t.item);document.getElementById("board-canvas").appendChild(o),re(o)})}function tn(e){setTimeout(()=>{if(document.querySelector(`.shape-box[data-shape-id="${e.whiteboard_item_id}"]`))return;const t=je(e);document.getElementById("board-canvas").appendChild(t),re(t)},100)}function on(e){const t=document.querySelector(`.shape-box[data-shape-id="${e.itemId}"]`);t&&t.remove()}function nn(e){var o,n,i,a,s;const t=document.querySelector(`.shape-box[data-shape-id="${e.itemId}"]`);if(t&&(t.style.left=e.posX+"px",t.style.top=e.posY+"px",t.style.transform=`rotate(${((o=e.meta)==null?void 0:o.rotation)??0}deg)`,(n=e.meta)!=null&&n.width&&(t.style.width=e.meta.width+"px"),(i=e.meta)!=null&&i.height&&(t.style.height=e.meta.height+"px"),(a=e.meta)!=null&&a.fillColor||(s=e.meta)!=null&&s.strokeColor)){t.dataset.fillColor=e.meta.fillColor,t.dataset.strokeColor=e.meta.strokeColor;const b=t.querySelector("svg");b.innerHTML=Pe(t.dataset.shapeType,e.meta.fillColor,e.meta.strokeColor,e.itemId)}}function Ke(e){const t=e.meta??{},o=document.createElement("div");return o.className="image-box absolute cursor-grab select-none",o.dataset.imageId=e.whiteboard_item_id,o.style.cssText=`
        left:${e.pos_x}px;top:${e.pos_y}px;
    ...
    `,o.innerHTML=`
        ...
        <div class="image-resize-handle" style="display:none;position:absolute;bottom:-4px;right:-4px;
            width:14px;height:14px;border-radius:2px;color:#374151;font-size:18px;line-height:14px;
            text-align:center;cursor:se-resize;z-index:10;user-select:none;">⤡</div>
    `,o}function le(e){e.addEventListener("mousedown",i=>lt(i,e)),e.addEventListener("touchstart",i=>lt(i,e),{passive:!1}),e.addEventListener("mouseenter",()=>{e.querySelector(".image-delete-btn").style.display="block",e.querySelector(".image-copy-btn").style.display="block",e.querySelector(".image-resize-handle").style.display="block"}),e.addEventListener("mouseleave",()=>{e.querySelector(".image-delete-btn").style.display="none",e.querySelector(".image-copy-btn").style.display="none",e.querySelector(".image-resize-handle").style.display="none"});const t=e.querySelector(".image-delete-btn");t.addEventListener("mousedown",i=>i.stopPropagation()),t.addEventListener("click",i=>{i.stopPropagation(),confirm("この画像を削除しますか？")&&fetch("/board/image/"+e.dataset.imageId,{method:"DELETE",headers:{"X-CSRF-TOKEN":d}}).then(a=>a.json()).then(()=>e.remove())});const o=e.querySelector(".image-copy-btn");o.addEventListener("mousedown",i=>i.stopPropagation()),o.addEventListener("click",i=>{i.stopPropagation(),rn(e)});const n=e.querySelector(".image-resize-handle");n.addEventListener("mousedown",i=>ct(i,e)),n.addEventListener("touchstart",i=>ct(i,e),{passive:!1})}let Se=null,O=null,Ze=0,Je=0,te=null,we=0,ze=0;function lt(e,t){if(e.target.classList.contains("image-delete-btn")||e.target.classList.contains("image-copy-btn")||e.target.classList.contains("image-resize-handle"))return;const o=e.touches?e.touches[0].clientX:e.clientX,n=e.touches?e.touches[0].clientY:e.clientY;te=t,we=o,ze=n,document.addEventListener("mousemove",Ue),document.addEventListener("mouseup",Ge)}function Ue(e){const t=e.clientX-we,o=e.clientY-ze;(Math.abs(t)>4||Math.abs(o)>4)&&(document.removeEventListener("mousemove",Ue),document.removeEventListener("mouseup",Ge),an(te,we,ze),te=null)}function Ge(){document.removeEventListener("mousemove",Ue),document.removeEventListener("mouseup",Ge),te=null}function an(e,t,o){Se=e;const n=e.getBoundingClientRect();Ze=t-n.left,Je=o-n.top,O=e.cloneNode(!0),O.style.cssText+=`position:fixed;pointer-events:none;z-index:9998;opacity:0.7;
        left:${n.left}px;top:${n.top}px;width:${n.width}px;height:${n.height}px;`,document.body.appendChild(O),e.style.opacity="0.3",document.addEventListener("mousemove",fo),document.addEventListener("mouseup",yo)}function fo(e){O.style.left=e.clientX-Ze+"px",O.style.top=e.clientY-Je+"px"}function yo(e){document.removeEventListener("mousemove",fo),document.removeEventListener("mouseup",yo),O.remove(),O=null;const t=l.getBoundingClientRect(),o=Se;let n=e.clientX-t.left+l.scrollLeft-Ze,i=e.clientY-t.top+l.scrollTop-Je;n=Math.max(0,Math.min(n,N-o.offsetWidth)),i=Math.max(0,Math.min(i,P-o.offsetHeight)),o.style.left=n+"px",o.style.top=i+"px",o.style.opacity="1",Se=null,mo(o,n,i)}function mo(e,t,o){const n=e.querySelector("img");fetch("/board/item",{method:"POST",headers:{"Content-Type":"application/json","X-CSRF-TOKEN":d},body:JSON.stringify({whiteboard_id:c,item_type:"image",item_id:parseInt(e.dataset.imageId),on_board:!0,pos_x:t,pos_y:o,meta:{src:n.src.replace(location.origin,""),width:e.offsetWidth,height:e.offsetHeight}})})}let C=null,bo=0,xo=0,go=0,vo=0;function ct(e,t){e.stopPropagation(),e.preventDefault(),C=t,bo=e.touches?e.touches[0].clientX:e.clientX,xo=e.touches?e.touches[0].clientY:e.clientY,go=t.offsetWidth,vo=t.offsetHeight,document.addEventListener("mousemove",Eo),document.addEventListener("mouseup",So)}function Eo(e){C&&(C.style.width=Math.max(40,go+(e.clientX-bo))+"px",C.style.height=Math.max(40,vo+(e.clientY-xo))+"px")}function So(){document.removeEventListener("mousemove",Eo),document.removeEventListener("mouseup",So),C&&(mo(C,parseFloat(C.style.left)||0,parseFloat(C.style.top)||0),C=null)}function sn(){const e=document.createElement("input");e.type="file",e.accept="image/*",e.addEventListener("change",()=>{const t=e.files[0];if(!t)return;const o=new FormData;o.append("whiteboard_id",c),o.append("image",t),fetch("/board/image",{method:"POST",headers:{"X-CSRF-TOKEN":d},body:o}).then(n=>n.json()).then(n=>{const i=Ke(n.item);document.getElementById("board-canvas").appendChild(i),le(i)})}),e.click()}function rn(e){const o=e.querySelector("img").src.replace(location.origin,"");fetch("/board/image/copy",{method:"POST",headers:{"Content-Type":"application/json","X-CSRF-TOKEN":d},body:JSON.stringify({whiteboard_id:c,src:o,width:e.offsetWidth,height:e.offsetHeight})}).then(n=>n.json()).then(n=>{const i=n.item;j!==e&&(w(0),W(e)),w(u+20),i.pos_x=(parseFloat(e.style.left)||0)+u,i.pos_y=(parseFloat(e.style.top)||0)+u;const a=Ke(i);a.querySelectorAll(".image-delete-btn, .image-copy-btn").forEach(s=>s.style.display="none"),a.querySelectorAll(".image-resize-handle").forEach(s=>s.style.display="none"),document.getElementById("board-canvas").appendChild(a),le(a),fetch("/board/item",{method:"POST",headers:{"Content-Type":"application/json","X-CSRF-TOKEN":d},body:JSON.stringify({whiteboard_id:c,item_type:"image",item_id:parseInt(i.whiteboard_item_id),on_board:!0,pos_x:i.pos_x,pos_y:i.pos_y,meta:i.meta})})})}function dn(e){setTimeout(()=>{if(document.querySelector(`.image-box[data-image-id="${e.whiteboard_item_id}"]`))return;const t=Ke(e);document.getElementById("board-canvas").appendChild(t),le(t)},100)}function ln(e){const t=document.querySelector(`.image-box[data-image-id="${e.itemId}"]`);t&&t.remove()}function cn(e){var o,n;const t=document.querySelector(`.image-box[data-image-id="${e.itemId}"]`);t&&(t.style.left=e.posX+"px",t.style.top=e.posY+"px",(o=e.meta)!=null&&o.width&&(t.style.width=e.meta.width+"px"),(n=e.meta)!=null&&n.height&&(t.style.height=e.meta.height+"px"))}window.addStaff=Io;window.addZone=Fo;window.addText=Ho;window.addShape=en;window.clearBoard=pn;window.addImage=sn;document.querySelectorAll(".magnet").forEach(e=>ie(e));document.querySelectorAll(".magnet-zone").forEach(e=>ae(e));document.querySelectorAll(".text-box").forEach(e=>se(e));document.querySelectorAll(".shape-box").forEach(e=>re(e));document.querySelectorAll(".image-box").forEach(e=>le(e));let oe=!1,wo=0,zo=0,Lo=0,_o=0;l.addEventListener("mousedown",e=>{if(e.target===l||e.target.id==="board-canvas"||e.target.closest("#board-canvas")===document.getElementById("board-canvas")&&!e.target.closest(".magnet")&&!e.target.closest(".magnet-zone")&&!e.target.closest(".text-box")&&!e.target.closest(".shape-box")&&!e.target.closest(".image-box")){const t=document.querySelector('.text-box-inner[contenteditable="true"]');if(t){t.blur();return}oe=!0,wo=e.clientX,zo=e.clientY,Lo=l.scrollLeft,_o=l.scrollTop,l.style.cursor="grabbing",e.preventDefault()}});document.addEventListener("mousemove",e=>{oe&&(l.scrollLeft=Lo-(e.clientX-wo),l.scrollTop=_o-(e.clientY-zo))});document.addEventListener("mouseup",()=>{oe&&(oe=!1,l.style.cursor="default")});document.getElementById("board-canvas").addEventListener("mousedown",e=>{if(e.target.closest(".text-box"))return;const t=document.querySelector('.text-box-inner[contenteditable="true"]');t&&t.blur()});window.Echo.channel("whiteboard."+c).listen(".board.updated",e=>{switch(e.action){case"item.updated":e.payload.itemType==="staff"&&Bo(e.payload),e.payload.itemType==="zone"&&Yo(e.payload),e.payload.itemType==="text"&&Jo(e.payload),e.payload.itemType==="shape"&&nn(e.payload),e.payload.itemType==="image"&&cn(e.payload);break;case"staff.added":$o(e.payload);break;case"staff.deleted":Oo(e.payload);break;case"staff.updated":Ro(e.payload);break;case"zone.added":Po(e.payload);break;case"zone.deleted":jo(e.payload);break;case"text.added":Ko(e.payload);break;case"text.deleted":Zo(e.payload);break;case"shape.added":tn(e.payload);break;case"shape.deleted":on(e.payload);break;case"image.added":dn(e.payload);break;case"image.deleted":ln(e.payload);break}});const pt=24,ut=120,Z=document.getElementById("ruler-top-inner"),J=document.getElementById("ruler-left-inner");if(Z&&J){for(let e=0;e<=N;e+=pt){const t=e%ut===0,o=document.createElement("div");if(o.style.cssText=`position:absolute;left:${e}px;bottom:0;width:1px;
            height:${t?6:3}px;background:${t?"#9ca3af":"#c8c6be"};`,Z.appendChild(o),t){const n=document.createElement("div");n.style.cssText=`position:absolute;left:${e+2}px;top:3px;
                font-size:9px;color:#9ca3af;`,n.textContent=e,Z.appendChild(n)}}for(let e=0;e<=P;e+=pt){const t=e%ut===0,o=document.createElement("div");if(o.style.cssText=`position:absolute;top:${e}px;right:0;height:1px;
            width:${t?6:3}px;background:${t?"#9ca3af":"#c8c6be"};`,J.appendChild(o),t){const n=document.createElement("div");n.style.cssText=`position:absolute;top:${e+2}px;left:1px;
                font-size:9px;color:#9ca3af;`,n.textContent=e,J.appendChild(n)}}l.addEventListener("scroll",()=>{Z.style.transform=`translateX(-${l.scrollLeft}px)`,J.style.transform=`translateY(-${l.scrollTop}px)`})}function pn(){confirm(`ボード上の全ての要素を削除しますか？
